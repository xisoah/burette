...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(410, 100, 181, 31))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.checkBox = QtWidgets.QCheckBox(self.memGroup)
        self.checkBox.setGeometry(QtCore.QRect(610, 100, 111, 20))
        self.checkBox.setObjectName("checkBox")
        self.tableView = QtWidgets.QTableView(self.tabPricing)
        self.tableView.setGeometry(QtCore.QRect(10, 10, 1180, 641))
        self.tableView.setObjectName("tableView")
        self.Spoopy = QtWidgets.QPushButton(self.tabPricing)
        self.Spoopy.setGeometry(QtCore.QRect(1150, 20, 30, 30))
        self.Spoopy.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Spoopy.setIcon(icon)
        self.Spoopy.setCheckable(False)
        self.Spoopy.setObjectName("Spoopy")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Delete Volume"))
